...
- [Step 1](#step-1---download-project-files-to-your-local-directory-using-git) - Download projects files
...
Trigger the Airflow DAG to pull data from the Reddit API (make sure your Reddit data is being stored in your S3 bucket)
